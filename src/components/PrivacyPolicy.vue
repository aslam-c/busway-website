<template>
  <div class="m-2">
    <main class="max-w-2xl mt-20 mx-auto">
      <h1 class="text-3xl font-display font-black">Privacy Policy</h1>
      <section class="text-gray-900 font-mono pb-8">
        <p class="text-sm text-gray-600">Last updated: March 29, 2021</p>
        <p class="my-4">
        ...
        <h2 class="text-2xl font-black italic">Interpretation</h2>
        <p class="my-4">
        ...
        <h2 class="text-2xl font-black italic">Definitions</h2>
        ...
        <ul class="list-disc">
          ...
          <li>
            ...
            Company downloaded by You on any electronic device, named BUSWAY
          </li>
          <li>
            <b>Company</b> (referred to as either “the Company”, “We”, “Us” or
            “Our” in this Agreement) refers to THEQOQ.
          </li>
          <li><b>Country</b> refers to: kerala, India</li>
          <li>
        ...
        <h2 class="text-2xl font-black italic">Types of Data Collected</h2>
        <b>Personal Data</b>
        <p class="my-4">
        ...
        <ul class="list-disc">
          <li>
            <b>To provide and maintain</b> our Service, including to monitor the
        ...
        <h1 class="text-3xl font-black">Disclosure of Your Personal Data</h1>
        ...
        <h1 class="text-3xl font-black">Security of Your Personal Data</h1>
        <p class="my-4">
        ...
        <h1 class="text-3xl font-black">Children's Privacy</h1>
        <p class="my-4">
        ...
        <h1 class="text-3xl font-black">Links to Other Websites</h1>
        <p class="my-4">
        ...
        <h1 class="text-3xl font-black">Changes to this Privacy Policy</h1>
        <p class="my-4">
